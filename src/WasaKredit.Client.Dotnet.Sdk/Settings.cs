namespace WasaKredit.Client.Dotnet.Sdk
{
    public static class Settings
    {
        ...
        public const string TEST_AUTHENTICATION_URL = "https://auth.inttest-b2b.wasakredit.se/connect/token";
        public const string TEST_CHECKOUT_GATEWAY_API_URL = "https://api.inttest-b2b.wasakredit.se";
    }
}
