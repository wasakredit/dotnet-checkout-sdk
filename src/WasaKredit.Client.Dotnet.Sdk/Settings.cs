namespace WasaKredit.Client.Dotnet.Sdk
{
    public static class Settings
    {
        ...
        public const string TEST_AUTHENTICATION_URL = "http://st1-b2b.services.wasakredit.se/auth/connect/token";
        public const string TEST_CHECKOUT_GATEWAY_API_URL = "http://st1-b2b.services.wasakredit.se";
    }
}
